...
program
  ...
  .option('--status', 'Show version and authentication status')
  .allowUnknownOption()
...
program
  ...
  .option('-k, --api-key <key>', 'Tavily API key (overrides global --api-key)')
...
program
  ...
  .option('--chunks-per-source <number>', 'Chunks per source', parseInt)
  .option('-k, --api-key <key>', 'Tavily API key (overrides global --api-key)')
  .option('--api-url <url>', 'Tavily API URL (overrides global --api-url)')
  .option('-o, --output <path>', 'Output file path')
  .option('--json', 'Output as JSON', false)
...
program
  ...
  .option('--max-breadth <number>', 'Maximum breadth per page', parseInt)
  .option('--limit <number>', 'Maximum number of pages', parseInt)
  .option('--extract-depth <depth>', 'Extract depth: basic or advanced')
...
program
  ...
  .option('--max-depth <number>', 'Maximum map depth', parseInt)
  .option('--max-breadth <number>', 'Maximum breadth per level', parseInt)
  .option('--limit <number>', 'Maximum URLs to return', parseInt)
  .option('--select-paths <patterns>', 'Comma-separated regex path filters')
  .option('--select-domains <patterns>', 'Comma-separated regex domain filters')
  .option('--exclude-paths <patterns>', 'Comma-separated regex path exclusions')
  .option(
